...
<div class="container">
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            <h1 class="panel-heading">Admin Edit User Data</h1>

            <div class="panel-body">
                <div class="form-group">
                    <div class="row">
                        <div class="col-xs-12">
                            <form method="POST" action="/edit-user-data/{{ $user->id }}/true">
                                {{ csrf_field() }}
                            ...
                            <form method="POST" action="/edit-user-data/{{ $user->id }}/true">
                                ...
                                <div class="form-check ">
                                    <label class="form-check-label">
                                        ...
                                        <input type="hidden" name="user_data_type" value="is_admin">
                                        <label for="is_admin">isAdmin</label>
                                    </label>
                                </div>
                                <button class="btn btn-default" type="submit" name="Submit">Update Admin Privileges</button>
                            </form>
                        </div>
                    </div>
                </div>
...
<script>
    ...
    if ({{ $user->is_admin == 1 }}) {
        isAdmin.setAttribute('checked', 'true');
    } else {
